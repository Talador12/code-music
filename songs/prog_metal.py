...
chorus.add_track(
    "guitar",
    [
        Chord("B", "min", 3, duration=2.5),
        Chord("G", "maj", 3, duration=2.5),
        Chord("D", "maj", 3, duration=2.5),
        Chord("A", "maj", 3, duration=2.5),
    ],
)
chorus.add_track(
    "bass", [Note("B", 1, 5.0), Note("G", 1, 5.0), Note("D", 2, 5.0), Note("A", 1, 5.0)]
)
...
song.effects = {
    "guitar": EffectsChain()
    .add(distortion, drive=3.5, tone=0.4, wet=0.5)
    .add(compress, threshold=0.4, ratio=5.0),
