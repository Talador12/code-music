...
song.effects = {
    "guitar": EffectsChain()
    .add(distortion, drive=3.0, tone=0.5, wet=0.5)
    .add(reverb, room_size=0.35, wet=0.12),
    "lead": EffectsChain()
    .add(distortion, drive=2.0, tone=0.6, wet=0.4)
    .add(compress, threshold=0.4, ratio=4.0),
}
