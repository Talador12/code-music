...
for _ in range(6):
    pad.extend(
        [
            Chord("E", "maj7", 3, duration=4.0),
            Chord("C#", "min7", 3, duration=4.0),
            Chord("A", "maj7", 3, duration=4.0),
            Chord("B", "maj", 3, duration=4.0),
        ]
    )
...
song.effects = {
    "guitar": EffectsChain()
    .add(chorus, rate=1.5, depth=0.3, wet=0.3)
    .add(delay, delay_ms=306, feedback=0.3, wet=0.2)
    .add(reverb, room_size=0.75, wet=0.4),
