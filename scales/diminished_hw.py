"""scales/diminished_hw.py — Diminished (Whole-Half)

    Alternating whole and half steps. Used over diminished 7th chords.
        Used in: jazz improvisation, neoclassical.

    All 12 keys in circle of fifths order: C G D A E B F# C# G# D# A# F
    Each key: ascending then descending.

    Run:
        code-music scales/diminished_hw.py -o /tmp/diminished_hw.wav
"""
from code_music import Note, Song, Track, scale

SCALE_TYPE = "diminished_hw"
CIRCLE = ["C", "G", "D", "A", "E", "B", "F#", "C#", "G#", "D#", "A#", "F"]

song = Song(title="Diminished (Whole-Half) — All Keys", bpm=112)
