...
78+ public functions across theory.py + composition.py. Toolkit complete.
...
whole_tone_run, blues_lick, arpeggio_pattern, lydian_run, mixolydian_lick, modal_interchange.
